                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-4 bg-orange-100 rounded-lg border border-orange-300">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h5 className="font-semibold text-orange-800 mb-2">Why Choose Emeritus Professor M Bouckaert?</h5>
                        <p className="text-orange-700 text-sm">
                          With extensive experience in complex wisdom tooth extractions, Emeritus Professor M Bouckaert uses advanced 
