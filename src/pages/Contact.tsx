    ...
    <div className="min-h-screen bg-background no-bounce">
      ...
      <section className="relative py-20 text-primary-foreground overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            src="https://res.cloudinary.com/dnnwvmh3n/image/upload/v1762171091/WhatsApp_Image_2025-11-01_at_15.31.09_uaydyu.jpg"
            alt="Contact Us"
                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-2">
                        Share referrals, imaging, or appointment requests.
                      </p>
                      <a
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-2">
                        Reach Mike for scheduling support and post-operative updates.
                      </p>
                      <a
                  ...
                  <p className="text-sm text-muted-foreground">
                    We respond as soon as possible. For urgent assistance, please call the rooms directly.
                  </p>
                </CardContent>
              </Card>
            </div>
