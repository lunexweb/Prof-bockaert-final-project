...
const PatientInfo = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "All surgical procedures carry some risk. Common risks include swelling, bruising, infection, and temporary numbness. Serious complications are rare. Emeritus Professor M Bouckaert will discuss all potential risks and benefits specific to your procedure during your consultation.",
    },
    {
