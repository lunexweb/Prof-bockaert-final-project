  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="https://res.cloudinary.com/dnnwvmh3n/image/upload/f_auto,q_auto/v1762171091/WhatsApp_Image_2025-11-01_at_15.31.08_x6z8hc.jpg"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-32">
        ...
        <div className="lg:hidden">
          <div className="max-w-4xl mx-auto text-center animate-fade-in mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-brand-black mb-6 leading-tight">
              Emeritus Professor M Bouckaert
            </h1>
            ...
            {/* Subtext */}
            <p className="text-base sm:text-lg text-black font-bold max-w-2xl mx-auto mb-8 leading-relaxed">
            ...
            <p className="text-sm text-black font-bold mb-8">
              Practice Number: <span className="font-bold text-brand-black">6201296</span>
            </p>
          </div>
          ...
          <div className="flex justify-center mb-8">
            <div className="relative group">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-3 shadow-xl border border-white/20 min-h-[320px] sm:min-h-[288px] min-w-[280px] sm:min-w-[224px]">
                <img
                  src="https://res.cloudinary.com/doqsolr8d/image/upload/f_auto,q_auto/v1760551693/WhatsApp_Image_2025-10-15_at_14.45.58_gfoocl.jpg"
                  alt="Emeritus Professor M Bouckaert"
                  className="w-64 h-80 sm:w-56 sm:h-72 object-cover rounded-xl shadow-lg object-right"
                  loading="lazy"
                  decoding="async"
                />
        ...
        <div className="hidden lg:block">
          ...
          <div className="max-w-3xl mr-0 xl:mr-96 text-left animate-fade-in">
            ...
            {/* Subtext */}
            <p className="text-lg sm:text-xl text-muted-foreground font-bold max-w-2xl mb-12 leading-relaxed">
              Advanced facial, jaw, and oral surgical care with precision and compassion. 
              Delivering excellence in maxillofacial surgery for over two decades.
            </p>
